...
class DependentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependent" do
    assert_difference('Dependent.count') do
      post dependents_url, params: { dependent: { d_blood_group: @dependent.d_blood_group, d_contact: @dependent.d_contact, d_date_of_birth: @dependent.d_date_of_birth, d_email: @dependent.d_email, d_name: @dependent.d_name, height: @dependent.height, relationship: @dependent.relationship, user_id: @dependent.user_id, weight: @dependent.weight } }
    end
  ...
  test "should update dependent" do
    patch dependent_url(@dependent), params: { dependent: { d_blood_group: @dependent.d_blood_group, d_contact: @dependent.d_contact, d_date_of_birth: @dependent.d_date_of_birth, d_email: @dependent.d_email, d_name: @dependent.d_name, height: @dependent.height, relationship: @dependent.relationship, user_id: @dependent.user_id, weight: @dependent.weight } }
